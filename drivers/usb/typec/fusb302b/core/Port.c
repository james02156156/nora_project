...
void InitializePDProtocolVariables(struct Port *port)
{
    port->FastGoodCRCBuffer[0] = SYNC1_TOKEN;
    port->FastGoodCRCBuffer[1] = SYNC1_TOKEN;
    port->FastGoodCRCBuffer[2] = SYNC1_TOKEN;
    port->FastGoodCRCBuffer[3] = SYNC2_TOKEN;
    port->FastGoodCRCBuffer[4] = 0x82;
    port->FastGoodCRCBuffer[5] = 0x81;
    port->FastGoodCRCBuffer[6] = 0x00;
    port->FastGoodCRCBuffer[7] = JAM_CRC;
